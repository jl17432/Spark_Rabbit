...
namespace SparkRabbit {
		...
		: m_Shader(shader)
	{
		...
		//Enable depth testing and blending by setting bitmasks.
	...
	Buffer& Material::GetUniformBufferTarget(ShaderUniformDeclaration* uniformDeclaration)
	{
		...
		SPARK_CORE_ASSERT(false, "Invalid uniform declaration domain! Material does not support this shader type."); 
